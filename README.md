...
[![GitHub release](https://img.shields.io/static/v1?label=release&message=v2.1.2&color=blue)](https://www.github.com/novicezk/midjourney-proxy)
...
docker run -d --name midjourney-proxy \
 ...
 --restart=always \
 novicezk/midjourney-proxy:2.1.2
```
